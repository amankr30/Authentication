...
export default function SignupPage(){
  ...
  const onSignup = async ()=>{
    ...
    return (
      ...
      <button className="p-2 border border-gray-300 rounded-lg mb-4 mt-4 focus:outline-none focus:border-gray-600">Signup</button>


      
      
      <Link href="/login"> <button className="p-2 border border-gray-300 rounded-lg mb-4 mt-4 focus:outline-none focus:border-gray-600">Go to Login</button></Link>
    </div>
    )
}
